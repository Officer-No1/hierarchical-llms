...
% - x0 - matrix of size [24x1]
% - all_parameters - matrix of size [48x1]
% Outputs:
% - outputs - column vector of length 24
function [outputs] = FORCESNLPsolver(xinit, x0, all_parameters)
    ...
    outputs = coder.nullcopy(zeros(24,1));
    outputs(1:12) = output.x1;
    outputs(13:24) = output.x2;
end
