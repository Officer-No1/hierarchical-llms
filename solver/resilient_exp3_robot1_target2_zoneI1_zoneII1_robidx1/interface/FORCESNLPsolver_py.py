...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['x0'] - matrix of size [12x1]
       PARAMS['all_parameters'] - matrix of size [36x1]

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x1'] - column vector of length 6
       OUTPUT['x2'] - column vector of length 6
...
('x0', ctypes.c_double * 12),
('all_parameters', ctypes.c_double * 36),
]
