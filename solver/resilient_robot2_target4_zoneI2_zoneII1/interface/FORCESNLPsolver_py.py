...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['x0'] - matrix of size [28x1]
       PARAMS['all_parameters'] - matrix of size [76x1]

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x1'] - column vector of length 14
       OUTPUT['x2'] - column vector of length 14
...
('x0', ctypes.c_double * 28),
('all_parameters', ctypes.c_double * 76),
]
...
#    def from_param(self):
#        return self
    _fields_ = [('x1', ctypes.c_double * 14),
('x2', ctypes.c_double * 14),
]
