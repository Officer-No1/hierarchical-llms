...
% - x0 - matrix of size [14x1]
% - all_parameters - matrix of size [58x1]
% Outputs:
% - outputs - column vector of length 14
function [outputs] = FORCESNLPsolver(xinit, x0, all_parameters)
    ...
    outputs = coder.nullcopy(zeros(14,1));
    outputs(1:7) = output.x1;
    outputs(8:14) = output.x2;
end
