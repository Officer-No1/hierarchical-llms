...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['xinit'] - matrix of size [2x1]
       PARAMS['x0'] - matrix of size [14x1]
       PARAMS['all_parameters'] - matrix of size [58x1]

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x1'] - column vector of length 7
       OUTPUT['x2'] - column vector of length 7
...
#    def from_param(self):
#        return self
    _fields_ = [('xinit', ctypes.c_double * 2),
('x0', ctypes.c_double * 14),
...
#    def from_param(self):
#        return self
    _fields_ = [('x1', ctypes.c_double * 7),
('x2', ctypes.c_double * 7),
]
